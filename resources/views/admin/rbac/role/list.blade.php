...
<div class="block-area" id="tableStriped">
    ...
    <h3 class="block-title"><a href="{{ route('admin.rbac.role.create') }}">添加角色</a></h3>
        ...
        <table class="tile table table-bordered table-striped">
            ...
            @foreach( $lists as $k=>$list )
                <tr>
                    ...
                    <td>
                    	<a href="{{ route('admin.rbac.role.show') }}" class="btn" >详情</a>
                    	<a href="{{ route('admin.rbac.role.edit') }}" class="btn" >修改</a>
                    	<a href="{{ route('admin.rbac.role.destroy') }}" class="btn" onclick="return confirm('确定删除吗?')" >删除</a>
                    </td>
