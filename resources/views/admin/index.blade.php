...
<div class="container-fluid am-cf">
    <div class="row">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
            <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 管理后台首页 <small></small></div>
            <p class="page-header-description">上次登录 IP   : {{ long2ip(session()->get('last_info')['ip']) }}</p>
            <p class="page-header-description">上次登录 时间  : {{ date('Y-m-d H:i:s', session()->get('last_info')['time']) }}</p>
            <p class="page-header-description">登录次数      : {{ session()->get('last_info')['count'] }}</p>
        </div>
